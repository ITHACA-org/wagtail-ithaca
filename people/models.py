...
from base.models import ContactFields, RelatedLink
...
class PersonIndexPage(Page):
    ...
    @cached_property
    def people(self):
        return PersonPage.objects.exclude(is_senior=True).live().public().order_by('last_name', 'first_name')

    @cached_property
    def senior_management(self):
        return PersonPage.objects.exclude(is_senior=False).live().public().order_by('-role', 'last_name')
